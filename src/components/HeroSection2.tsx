...
function HeroSection2() {
  return (
    <>
      ...
      <div className="h-full md:h-screen w-full md:w-auto flex flex-col items-start md:items-center justify-start md:justify-evenly overflow-auto overflow-x-hidden mx-auto md:py-0 py-4">
        <div className="w-full md:w-10/12 h-screen md:h-screen flex flex-col md:flex-row items-center justify-evenly mx-auto  rounded- lg md:rounded-2xl    hover:shadow-lg hover:shadow-orange-500 md:mb-12">
          <div className="w-full md:w-1/3 h-full flex flex-col items-start justify-start p-2 md:p-4">
            ...
            <div className="md:text-4xl text-2xl text-white font-semibold md:font-extrabold leading-12 mt-2 md:mt-4">
